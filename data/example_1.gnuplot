...
plot '../data/demod_time_1.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#000088' notitle
...
plot '../data/demod_freq_1.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#008800' notitle

# freq domain (PSD)
set ylabel 'Spectrum (dB/Hz)'            # set y-axis label
set xlabel 'Frequency (KHz)'             # set x-axis label
set yrange [-100:0]                       # set y plot range
set xrange [0:120000]                       # set x plot range
plot '../data/demod_psd_1.dat' using 1:2 with lines lt 1 lw 3 lc rgb '#880000' notitle
